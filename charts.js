...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var resultArray = sampleData.filter(sampleNum => sampleNum.id == sample)
    ...
    var metaData = data.metadata;
    var metaResultArray = metaData.filter(sampleNum => sampleNum.id == sample)
    ...
    var gaugeData = [{
      ...
      type: "indicator", 
      mode: "gauge+number",
      title: { text: "Belly Button Washing Frequency", color: "black"},
      gauge: {
